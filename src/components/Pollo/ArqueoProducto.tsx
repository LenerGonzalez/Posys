...
export default function ArqueoProducto(): React.ReactElement {
  ...
  const handleDeleteAudit = async (auditId: string) => {
    ...
    try {
      await db.collection("inventory_audits_pollo").doc(auditId).delete();
  ...
  const loadRows = async () => {
    ...
    try {
      ...
      console.error("Error cargando productos para arqueo:", e);
      setRows([]);
      setLoaded(false);
              ...
              <tr key={a.id} className="text-center">
                ...
                <td className="border p-1">
                  <div className="relative inline-block text-left">
                    ...
                    {openMenuId === a.id && (
                      <div className="absolute z-10 right-0 top-auto bottom-full mb-2 w-40 bg-white border rounded shadow-lg overflow-visible">
                        <button
                          type="button"
